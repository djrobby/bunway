...
Build the complete [Bunway Showcase](./index.md), the publishing and operations application used throughout these docs. You will compose CRUD,
...
same named surfaces as the finished Showcase: Products, Categories, the Blog, Realtime, Auth, Audit,
...
| 4    | `/examples/messaging` Mail/SMS demo and sidebar link                            |
| 5    | `/realtime` SSE/WebSocket demo and sidebar link; PostgreSQL durable processing  |
| 6    | password Auth, OAuth setup, TOTP, backup codes, protected routes                |
| 7    | `/examples/audit` durable history demo and sidebar link                         |
| 8    | tests, production build, and deployment plan                                    |
